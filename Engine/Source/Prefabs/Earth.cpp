...
{
	void Earth::Create(float radius, float slices, float stacks)
	{
	...
	void Earth::Draw(glm::mat4 view_matrix, glm::mat4 projection_matrix) {
	...
	void Earth::DrawPlanet(GLuint shader_program, std::string planet_texture,

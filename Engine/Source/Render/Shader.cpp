...
namespace HoloGraphicEngine
{
	...
	GLuint Shader::CreateShader(GLenum shader_type,
	...
	void Shader::CreateProgram(const std::string& shader_name,
	...
	const GLuint Shader::GetShader(const std::string& shader_name) {
